							...
							<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${boardList }" var="board">
										<tr data-boNo="${board.boNo }" class="board">
											<td>${board.boNo }</td>
											<td>${board.boTitle }</td>
											<td>${board.boDate }</td>
										</tr>
						...
						<table class="table">
							...
							<c:otherwise>
								<c:forEach items="${noticeList }" var="notice">
									<tr data-boNo="${notice.boNo }" class="noti">
										<td>${notice.boNo }</td>
						...
						<table class="table">
							...
							<c:otherwise>
								<c:forEach items="${freeList }" var="free">
									<tr data-boNo="${free.boNo }" class="free">
										<td>${free.boNo }</td>
										<td>${free.boTitle }</td>
										<td>${free.boDate }</td>
									</tr>
...
$(function(){
	...
	tr.click(function() {
		...
		if($(this).attr("class") == "noti") {
			location.href="/notice/detail.do?boNo="+boNo;
		}
		if($(this).attr("class") == "board") {
