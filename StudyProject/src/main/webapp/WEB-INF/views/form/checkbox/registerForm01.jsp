	...
	<form:form modelAttribute="member" method="post" action="/formtag/checkbox/result">
		<table>
			...
			<tr>
				<td>취미(hobby)</td>
				<td>
					<form:checkbox path="hobby" value="Sports" label="Sprots"/><br/>
			...
			<tr>
				<td>취미(hobbyArray)</td>
				<td>
					<form:checkbox path="hobbyArray" value="Sports" label="Sprots"/><br/>
			...
			<tr>
				<td>취미(hobbyList)</td>
				<td>
					<form:checkbox path="hobbyList" value="Sports" label="Sprots"/><br/>
