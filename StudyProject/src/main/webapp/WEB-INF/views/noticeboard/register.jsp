		...
		<div class="card-body">
			...
			<form action="/notice/signup.do" method="post" id="signupForm" enctype="multipart/form-data">
				...
				<div class="input-group mb-3">
					...
					<span class="error invalid-feedback" style="display:block;" id="id">${errors.memId }</span>
				</div>
				<div class="input-group mb-3">
...
$(function(){
	...
	var idCheckFlag = false;			// 중복확인 Flag 값
	...
	signupBtn.on("click", function(){
		...
		// 개인정보 처리 방침을 동의하게 되면 Y, 동의 여부는 true로 설정
		var memAgree = $("#memAgree:checked").val();
		if(memAgree == "Y") {
			agreeFlag = true;
		}
		
		if(agreeFlag) {	// 개인정보 동의
