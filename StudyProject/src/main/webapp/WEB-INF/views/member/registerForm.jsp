...
<body>
	...
	<p>
		...
		<font color="red">서버 쪽 컨트롤러 메소드에서 @PathVariable를 사용하지 않는 경우 파라미터로 해당 값을 얻을 수 없다.(null)</font>
	</p>
	...
	<p>4) HTML Form 필트가 여러개일 경우에도 컨트롤러 매개변수명이 일치하면 요청 데이터를 취득할 수 있다.</p>
	...
	<p>2) HTML 폼의 필드명과 컨트롤러 매개변수 명이 일치하면 요청을 처리할 수 있다.</p>
	...
	<h4>5. Date 타입 처리</h4>
	<hr/>
	<p>쿼리 파라미터(dateOfBirth=1234)로 전달받은 값이 날짜 문자열 형식에 맞지 않아 Date 타입으로 변환에 실패한다.</p>
	...
	<p>16) 폼 텍스트 필드 요소값으로 중첩된 자바빈즈 매개변수로 처리한다.</p>
	...
	<hr/><br/>
	<form action="/registerAllForm" method="get">
	...
	<font color="red">FAILED 안되용 쓰려면 아래거 참고하세용</font><br/>
	
	<p>7) 여러개의 파일 업로드 폼 파일 요소값과 텍스트 필드 요소값을 MultiFileMember 타입의 자바빈즈 매개변수로 처리한다.</p>
