...
public class HomeController {
	...
	*/
	...
	// 해당경로 : D드라이브 > workspace > .metadata > .plugins > ,,, > DevProject > WEB-INF > views > sub > ,,, .jsp
	...
	*/
	...
	// 반환값이 컬렉션 Map 타입이면 JSON 객체 배열 타입으로 자동 변환된다.
	@ResponseBody
	...
	*/
	...
	public ResponseEntity<Void> goHome0601() {
		...
		// 해당 URL 요청 후, 브라우저에서 개발자 도구 이용하여 네트워크 탭을 확인해보면 응답으로 URL이 응답된 걸 확인할 수 있는데,
	...
	*/
	...
	public ResponseEntity<byte[]> goHome1101() {
		...
		try(InputStream in = new FileInputStream("D:/image/chopa.jpg")) {
			// 파일 경로를 나타내는 방법 2가지
			// 방법 1('\\')
//			in = new FileInputStream("D:\\image\\chopa.jpg");
			// 방법 2('/')
